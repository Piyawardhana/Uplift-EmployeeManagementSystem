...
<div class="nav">
  <nav style="opacity: 0.9;">
    <ul style="list-style: none;">
      <li><form method="POST" action="viewAll"><button class="block" style="margin-top:70px">View Pending</button></form></li>
      <li style="padding-top:10px"><form method="POST" action="approved"><button class="block">View Approved</button></form></li>
    </ul>
  </nav>
</div>
...
<div style="opacity: 0.9;">
	...
	<h2>Employee ID:</h2><input type="text" name="empId" value ="<%= Allowance.getEmpId() %>" readonly><br>
	<h2>Date:</h2><input type="text" name="appDate" value ="<%= today %>" readonly><br>
	...
	<h2>Unit Price:</h2><input type="text" name="unitPrice" id="UnitPrice" onkeyup="In()" required><p style="color:red; font-style: italic" id="demo2"></p>
	<h2>Quantity:</h2><input type="text" name="qty" id="Qty" onkeyup="In()" required><p style="color:red; font-style: italic" id="demo3"></p><br><br>
...
%>
	...
	<c:set var="allowaID" value="<%=obj.getAllowanceId()%>"/>
	<c:set var="empID" value="<%=Allowance.getEmpId()%>"/>
	<c:set var="type" value="<%=obj.getType()%>"/>
	<c:set var="unitPrice" value="<%=obj.getUnitPrice()%>"/>
	<c:set var="qty" value="<%=obj.getQty()%>"/>
	<c:set var="total" value="<%=obj.getTotal()%>"/>
...
<table style="border: 2px solid #000000;">
	...
	<td>
	<a href="${allUpdate}">
	<input type="submit" name="btnsubmit1" id="submit1" value="Edit">
  	</a>
	</td>
	</tr>
</table>
