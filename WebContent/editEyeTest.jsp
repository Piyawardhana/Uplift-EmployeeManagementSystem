...
<form method="POST" action="editEyeTest">
	...
	<h2>Pick a Date for Eye Test:</h2><span style="color:#FF0000"><input type="date" name="date" value ="<%= request.getParameter("date") %>" required></span><br><br>
